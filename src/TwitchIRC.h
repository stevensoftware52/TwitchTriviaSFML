...
{
	public:
	    TwitchIRC(Game* game, const std::string nick, const std::string usr, const std::string addr, const uint32 port, const std::string channel, const std::string password = "");
	    ~TwitchIRC();
